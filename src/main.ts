    ...
    try {
        ...
        if (!clipboardCleared) {
            ...
            return {
                ...
                status: 'no_email',
                error:
                    'Could not clear clipboard before copying.',
            };
        }
        ...
        await directContainer.copyButton.click({
            timeout: 15_000,
        });
